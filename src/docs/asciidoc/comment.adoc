...
include::{snippets}/comment/save-reply/curl-request.adoc[]

=== 응답

include::{snippets}/comment/save-reply/http-response.adoc[]

=== 요청 파라미터

include::{snippets}/comment/save-reply/request-fields.adoc[]

=== 응답 파라미터

include::{snippets}/comment/save-reply/response-fields.adoc[]
