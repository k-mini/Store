package com.kmini.store.domain.admin.statistics.board.service;

import com.kmini.store.domain.admin.statistics.board.repository.BoardStatisticsRepository;
