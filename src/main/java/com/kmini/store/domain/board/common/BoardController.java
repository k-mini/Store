...
//            @PathVariable("subCategory") String subCategoryName,
        ...
        Page<BoardResponseDto> results = boardService.viewBoardList(pageable, searchBoardDto).map(BoardResponseDto::toDto);
        for (BoardResponseDto result : results.getContent()) {
