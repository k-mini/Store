package com.kmini.store.domain.board.item;
...
import com.kmini.store.domain.board.item.dto.ItemBoardRequestDto.ItemBoardSaveReqApiDto;
import com.kmini.store.domain.board.item.dto.ItemBoardRequestDto.ItemBoardUpdateReqApiDto;
...
import com.kmini.store.domain.board.item.dto.ItemBoardReponseDto.ItemBoardUpdateRespDto;
